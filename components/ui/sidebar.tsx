        ...
        if (isMobile) {
            return (
                ...
                >
                    ...
                    <div
                        className={cn(
                            "relative flex h-full w-[--sidebar-width-mobile] flex-col bg-sidebar text-sidebar-foreground transition-transform duration-300",
                            side === "left"
                                ? openMobile
                                    ? "translate-x-0"
                                    : "-translate-x-full"
    ...
    return (
        <button
            ...
            className={cn(
                ...
                "[[data-side=left][data-state=collapsed]_&]:cursor-w-resize [[data-side=left][data-state=expanded]_&]:cursor-e-resize [[data-side=right][data-state=collapsed]_&]:cursor-e-resize [[data-side=right][data-state=expanded]_&]:cursor-w-resize",
...
>(({ className, showIcon = false, ...props }, ref) => {
    // Extract width for skeleton from the size prop if needed.
